    ...
    <div id="experience" className="w-full text-black mt-30 px-5">
      ...
      <div className="text-center my-10">
        {experiences.map((experience, index) => (
          <div className="grid grid-cols-[1fr_3px_1fr] gap-3" key={index}>
            <div
            ...
            <div className="w-full bg-black/50 h-full col-start-2 relative">
              <div className="absolute left-[-8px] top-6 bg-blue-500 border-[4px] border-white shadow-lg w-5 h-5 rounded-full"></div>
            </div>
            <div className="max-w-[400px] pt-5">
              ...
              <p className="opacity-60 text-left pl-5">
                ...
                laudantium veniam repudiandae id iure quidem sit nostrum
                adipisci, ipsum ea?
              </p>
            </div>
          </div>
